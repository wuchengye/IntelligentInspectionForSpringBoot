...
public class V3toWAV {
    ...
    public static void voxConvert(String inFile, String outFile, int voxFormat,  
        ...
        //检测文件夹是否存在
        int last = outFile.lastIndexOf("/");
        File outDir = new File(outFile.substring(0, last));
        if(!outDir.exists()){
        	//如果不存在则新建文件夹
        	outDir.mkdirs();
        }
	...
	public static void main(String[] args) {
		...
		String inFile  = "D:/BDANLP/BDAQA/录音/1148055.V3";  
        String outFile = "D:/BDANLP/BDAQA/录音1/录音2/_0717262TEST.wav";  
