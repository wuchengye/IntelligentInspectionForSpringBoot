...
//                     thisStr = '"' + rtss.toString() + '"';  
             ...
             if (thisStr == null || "".equals(isCellNull)) {  
            	 ...
            	 record[thisColumn] = thisStr;  					//  xuying.chen    null时不设置到record[]里面
             }
...
//     List<String[]> list = XLSXCovertCSVReader.readerExcel("C:\\Users\\chenxuying\\Desktop\\员工信息批量导入或修改模板.xlsx","Sheet1", 17);  
