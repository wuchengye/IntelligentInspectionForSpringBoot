...
public class UserOprService extends AbstractService<User>{
	...
	public List<User> getUserWithUserRole(String keyword){
		return userMapper.getUserWithUserRole(keyword);
	}

	public List<User> getUserWithoutUserRole(String keyword){
		return userMapper.getUserWithoutUserRole(keyword);
	}

	public List<Map<String,Object>> getUserAndUserRole(String keyword){
		return userMapper.getUserAndUserRole(keyword);
	}
