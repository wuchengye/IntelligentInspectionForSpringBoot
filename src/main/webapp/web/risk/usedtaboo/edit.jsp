	...
	<table >
		<tbody>
			<tr>
				<td>人员是否存在问题:</td>
				<td>
					<select name="personIsProblem"  style="width:200px;" >
				...
				<td>转写是否正确:</td>
				<td>
					<select name="transferIstrue"  style="width:200px;" >
...
<script>
	$(function(){
		seajs.use([ 'module/risk/hotlineintaboo.js' ], function(hotlinetaboo) {
