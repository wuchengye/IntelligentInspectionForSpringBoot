...
//	var getwrongwords = require("module/commonUtil/getwrongwords.js");
	...
	var getPowerNumAndCheckUrl = moduleRootUrl + 'getPowerNumAndCheck';
	
	var getGroupNumAndCheckUrl = moduleRootUrl + 'getGroupNumAndCheck';
	
	var getOpenRoomNumAndCheckUrl = moduleRootUrl + 'getOpenRoomNumAndCheck';
	
	var getLineNumAndCheckUrl = moduleRootUrl + 'getLineNumAndCheck';
	...
	TicketNumCharts.prototype = {
		...
		init:function(){
			...
			self.$chartToolBar.on("click",".bda-btn-hitlsn-query",function(){
				...
				self.doSearchBar6(unit,beginTime,endTime);
		...
		initBar1:function(data){
	        ...
	        myChart1.on('click', function (params) { 
				...
				var endTime = $("#endTime").datetimebox("getValue");
				var unit = $("#data_query").combobox("getValue");
				var findUrl = "electric/ticketExplore/getPowerNumAndCheck";
		...
		initBar4:function(data){
	        ...
	        myChart4.on('click', function (params) { 
				...
				var endTime = $("#endTime").datetimebox("getValue");
				var unit = $("#data_query").combobox("getValue");
				var findUrl = "electric/ticketExplore/getOpenRoomNumAndCheck";
				var seriesIndex = params.seriesIndex;
	        	$("#batch_manage_dialog").dialog({
					title:'数据展示',
					width:'85%',
		...
		initBar5:function(data){
	        ...
	        myChart5.on('click', function (params) { 
				...
				var endTime = $("#endTime").datetimebox("getValue");
				var unit = $("#data_query").combobox("getValue");
				var findUrl = "electric/ticketExplore/getLineNumAndCheck";
				var seriesIndex = params.seriesIndex;
	        	$("#batch_manage_dialog").dialog({
					title:'数据展示',
					width:'85%',
		...
		doSearchBar6:function(unit,beginTime,endTime){
			var self = this;
