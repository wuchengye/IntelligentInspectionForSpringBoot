		...
		<form id="detailPageForm" action="">
			...
			<table>
				<tr>
					...
					<td>对应工作票编号</td>
					<td><input class="detail_inp" type="text" value="${TicketCheck.ticketNo}" /></td>
				</tr>
				<tr>
				<td>动火部门</td>
				<td>
				...
				<td>班组</td>
				<td>
					 <input class="detail_inp work_member_count" type='text' style="width:80%;text-align: center;" value="${TicketCheck.department}"/>
				</td>
				...
				<tr>
				<td colspan="4">
				 <label>动火工作任务(附示意图))：<input class="detail_inp" type='text' style="width:80%;" value="${TicketCheck.workTask }" /></label>
				</td>
				</tr>
				...
				<tr>
				 <td style="text-align: center;">动火工作签发人</td>
				 <td rowspan="2" style="text-align:center;">审批人签章</td>
				 <td colspan="2" style="text-align: center;">运维单位安全监察部门负责人</td>
				</tr>
				...
				<td colspan="2">
				   <input style="width:80%;" class="detail_inp" type='text' value="${TicketCheck.saftyStartUname }"/>
				</td>
			    </tr>
			    ...
			    <td colspan="3">
			     <input class="detail_inp"  value="${TicketCheck.receiveTime }"/>
			    </td>
			    </tr>
			    ...
			    <td colspan="4">
			     ...
			     <span>时间：</span><input class="detail_inp" type="text" value="${TicketCheck.workPermissionTime}"/>
			    </td>
			    </tr>
			    ...
			    <tr>
			    <td colspan="4">
			     <span class ="permission_time">允许动火时间自</span><input class="detail_inp permission_time" type="text" value=""/><br/>
			     <span>动火工作负责人签名：</span><input class="detail_inp" type="text" value="${TicketCheck.workPrincipal }"/>&nbsp;&nbsp;
			     <span>动火工作监护人签名：</span><input class="detail_inp" type="text" value="${TicketCheck.workGuardianUname }"/>
