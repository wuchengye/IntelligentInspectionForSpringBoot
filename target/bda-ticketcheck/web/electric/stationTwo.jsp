...
<body>
	<div class="easyui-layout" style="width: 100%; height: 100%;border:none;">
		...
		<table>
			...
			<tr>
				<td rowspan="3" class='noTopBorder td1'><span>工作条件</span></td>
			</tr>
			<tr>
				<td colspan="2" class='noTopBorder' >相关高压设备状态：
			...
			<tr>
				<td colspan="2" class='noTopBorder' >相关直流、低压及二次回路状态：
				<br/><textarea class="easyui-validatebox" name="content_1" id="content_1" style='height:49px;border:0;background-color:transparent;' required="required"></textarea>
			</tr>
			<tr>
...
<script type="text/javascript">
	$(function() {
		...
		//seajs.use([ 'module/electric/workTicket.js?v=20190219' ], function(kwa) {
		//	kwa.init();
		//});		
	});
