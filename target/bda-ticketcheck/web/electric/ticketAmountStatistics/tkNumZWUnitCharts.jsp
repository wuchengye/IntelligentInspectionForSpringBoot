...
<body>
				       ...
				       style="width:100%;padding:0% 2%;border-collapse:separate; border-spacing:0px 5px;">
						<tr>
						   ...
						   日期：<input id="beginTime" name="beginTime" class="easyui-datebox"   style="width:105px;" data-options="prompt:'开始日期',editable:false" required="required"/>
						    ...
						    data-options="panelHeight:'auto',panelMaxHeight:250,panelWidth:135,editable:true,valueField:'value',textField:'text',url:'electric/organization/getZWCombox?unitType=ZW'" required="required"/>
	...
	$(function() {
		seajs.use([ 'module/electric/ticketAmountStatistics/tkNumZWUnitCharts.js' ], function(t) {
			t.init();
		});		
