...
<body>
	<div class="easyui-layout" style="width: 100%; height: 100%;">
		...
		<div data-options="region:'north',border:false" style="height: 100%;">
		    ...
		    <div style="width: 100%;height: 55%;margin: 15px auto;">
		        <div style="display:inline-block;width: 96%;height:100%;margin-left:2%;border: 1px #dedede solid;">
	...
	$(function() {
		seajs.use([ 'module/electric/ticketAmountStatistics/ticketTypeAllUnitCharts.js' ], function(t) {
			t.init();
		});		
	})
	</script>
