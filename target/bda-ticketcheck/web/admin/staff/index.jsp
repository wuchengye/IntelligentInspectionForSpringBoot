		...
		<table cellpadding="0" cellspacing="0" style="width:100%">
			<tr>
				<td style="padding-left:2px">
					...
					<!-- <a href="#" class="easyui-linkbutton bda-btn-workgroup" iconCls="icon-dbtable" plain="true">班组信息管理</a> -->
					<a href="javascript:void(0);" class="easyui-linkbutton bda-btn-imp" iconCls="icon-save" plain="true">员工信息批量导入</a>
				</td>
				<td style="text-align:right;padding-right:2px">
					<input class="js-searchbox" style="width:250px" data-options="prompt:'员工姓名/工号/所属组织'"></input>
				</td>
			</tr>
		</table>
	</div>
