		...
		<form id="import_userDetail_form" action="datamanage/userDetail/import" method="post" enctype="multipart/form-data">
			<table>
				...
				<tr>
					...
					<td><a href="upload/dataManage/template/员工信息批量导入或修改模板.xlsx" class="template">员工信息批量导入或修改模板.xlsx</a></td>
				</tr>
			</table>
		</form>
		<!-- <div style="text-indent:2em;float:left;margin-top:10px">导入模板：
			<a href="upload/dataManage/template/员工信息批量导入或修改模板.xlsx" class="template">员工信息批量导入或修改模板.xlsx</a>
		</div> -->
	</div>
	<script>
		/* $(function(){
